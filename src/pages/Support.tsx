    ...
    <div className="bg-slate-200 min-h-screen">
      ...
      <div className="max-w-3xl mx-auto py-10 px-6">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Support & About KY Software</h1>
        ...
        {/* Mission & Story */}
        <section className="bg-white rounded-2xl shadow border p-6 mb-8">
        ...
        <section className="bg-white rounded-2xl shadow border p-6">
          ...
          <ul className="space-y-3 text-gray-700 text-md">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="https://www.linkedin.com/company/k-y-software/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="hover:underline">
